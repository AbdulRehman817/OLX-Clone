...
const Catagories = () => {
  return (
    <>
      <div className="pt-28">
        <div className="">
          <div className="-mb-[3rem] ml-28">
            <span className=" text-[#002f34] text-[2rem] font-bold">
              All Categories
            </span>
          </div>
          <div className="flex flex-wrap p-[5.5rem] gap-9">
            <div>
              <img
                classname="w-4"
                ...
                alt=""
              />
              <p className="text-[1.2rem] font-bold leading-8 text-center mt-[0.8rem] 	text-[#002f34]">
                Mobile Phone
              </p>
            </div>
            <div>
