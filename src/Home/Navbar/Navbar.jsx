      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            {isMenuOpen && (
              <ul className="absolute right-0 mt-2 w-56 bg-white shadow-xl rounded-2xl py-4 z-20">
                <li className="px-4 py-3 rounded-t-lg bg-gradient-to-r from-gray-50 to-white text-gray-800 font-medium shadow-inner border-b border-gray-200">
                  {fullname || "Guest"}
                </li>
                <li
                  className="px-4 py-3 cursor-pointer rounded-lg flex items-center space-x-2 hover:bg-teal-100 hover:text-teal-900 hover:shadow-md hover:scale-105 transition-transform duration-200 ease-in-out text-gray-700"
                  onClick={home}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <li className="px-4 py-3 cursor-pointer rounded-lg flex items-center space-x-2 hover:bg-teal-100 hover:text-teal-900 hover:shadow-md  hover:scale-105 transition-transform duration-200 ease-in-out text-gray-700">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 text-teal-500"
                    fill="none"
